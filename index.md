...
<table class="table-responsive-sm filterDiv Agathion Sudama">
	<tr>
...
<table class="table-responsive-sm filterDiv Ippon-Datara Bicorn Berith Oni Anubis Belphegor Hanuman Kumbhanda Koropokguru">
	<tr>
